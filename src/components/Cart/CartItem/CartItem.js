  ...
  return(
    <div className="cart-item">
       ...
       <div className="container">
            <img className="cart-img" src={prop.item.image} alt="cartimage"></img>
       </div>
       <div className="container">
      ...
      <button className="delbutton" onClick={()=>delfunction(prop.item)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
